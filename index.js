//import resources from libary and file
...
//set to connect the myalgo wallet
...
class App extends React.Component {
    ...
    selectAttacher() {
        this.setState({
            view: 'Wrapper', ContentView: Attacher,
        });
    }

    selectDeployer() {
        this.setState({
            view: 'Wrapper', ContentView: Deployer,
        });
    }
...
class Deployer extends Player {
    ...
    async deploy() {
        ...
        this.setState({
            view: 'WaitingForAttacher', ctcInfoStr
        });
    }
...
class Attacher extends Player {
    ...
    async acceptWager(wagerAtomic) {
        ...
        return await new Promise(resolveAcceptedP => {
            this.setState({
                view: 'AcceptTerms', wager, resolveAcceptedP
            });
        });
    }
